...
O Brasil obteve as seguintes posições no ano de 2018: 68ª posição no PISA, com a média de 400 pontos dos resultados de leitura, matemática e ciências; 86ª posição  no QS-WUR, em que apenas a Universidade de São Paulo (USP) aparece entre as universidades do pais no top 100 do ranking \cite{amaral2024educacaoBrasil}.
