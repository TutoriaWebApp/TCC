...
Segundo \citeonline{wiegers2023software}, Requisitos Não Funcioanais (RNFs), também conhecidos como requisitos de atributos de qualidade, descrevem várias características de qualidade, serviço ou desempenho que a solução deve possuir. Enquanto os requisitos funcionais focam no comportamento do sistema (o que ele faz), os atributos de qualidade definem propriedades do sistema (o quão bem ele faz). Tais expectativas dos usuários, muitas vezes não declaradas explicitamente, e incluem características como usabilidade e segurança.

Ainda conforme \citeonline{wiegers2023software}, os RNFs são fundamentais porque determinam decisões de arquitetura do software, evitam retrabalho (identificar esses requisitos cedo reduz o risco de ter que realizar modificações caras e invasivas posteriormente no desenvolvimento) e aumentam a satisfação do usuário.
